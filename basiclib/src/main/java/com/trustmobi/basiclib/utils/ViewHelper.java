...
public class ViewHelper {
     ...
     * <p>相关方法 {@link #slideOut(View, int, Animation.AnimationListener, boolean, ViewDirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, ViewDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
     ...
     * <p>相关方法 {@link #slideIn(View, int, Animation.AnimationListener, boolean, ViewDirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, ViewDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
