...
public class AppUtil {
    ...
    public static String getWifiMac(Context var0) {
        String var1 = "";
        if (!TextUtils.isEmpty(wifiMac)) {
            ...
            try {
                ...
                WifiInfo var3 = null == var2 ? null : var2.getConnectionInfo();
                var1 = var3 == null ? "" : var3.getMacAddress();
    ...
    private static PackageInfo parsePackage(String archiveFilePath, int flag) {
        try {
            ...
            Method method_parsePackage = packageParser.getDeclaredMethod("parsePackage", new Class[]{File.class, String.class, DisplayMetrics.class, Integer.TYPE});
            Method method_collectCertificates = packageParser.getDeclaredMethod("collectCertificates", new Class[]{var4, Integer.TYPE});
            Method method_generatePackageInfo = packageParser.getDeclaredMethod("generatePackageInfo", new Class[]{var4, int[].class, Integer.TYPE, Long.TYPE, Long.TYPE});
